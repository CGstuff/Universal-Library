"""
LightTheme - Light theme implementation
...
class LightTheme(Theme):
    ...
    def __init__(self):
        palette = ColorPalette(
            ...
            # Header gradient (blue for USD theme)
            header_gradient_start="#2874a6",
            header_gradient_end="#3498db",
            header_icon_color="#ffffff",

            # List item colors (for dropdowns, lists, menus)
            list_item_background="#ffffff",
            list_item_hover="#e3f2fd",
            list_item_selected="#0078d4",
            selection_border="#0078d4",
        )

        super().__init__("Light", palette, is_dark=False)
...
QWidget {{
    ...
    font-family: "{Fonts.DEFAULT.family}", Arial, sans-serif;`n    font-size: {Fonts.DEFAULT.size}px;
}}
